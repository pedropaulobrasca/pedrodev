...
export const Skills = () => {
  ...
  return (
    <section ref={ref} className="relative py-20 px-4 sm:px-6 lg:px-8">
      <div className="absolute inset-0 bg-cyber-darker/40"></div>
      ...
      <div className="max-w-4xl mx-auto relative z-10">
        <div className="grid md:grid-cols-2 gap-12">
          <motion.div
            ...
            className="cyberpunk-border p-6 backdrop-blur-sm bg-cyber-darker/20"
          >
            ...
            <div className="flex flex-wrap gap-3">
              {technicalSkills.map((skill, index) => (
                <motion.span
                  ...
                  className="px-4 py-2 backdrop-blur-sm bg-cyber-darker/30 text-neon-blue border border-neon-blue hover:bg-neon-blue/10 transition-colors animate-glow-blue font-mono"
                >
                  {skill}
                </motion.span>
              ))}
          ...
          >
            <div className="flex items-center gap-4 mb-8">
              <Users className="w-8 h-8 text-neon-pink animate-glow-pink" />
            ...
            <div className="flex flex-wrap gap-3">
              {softSkills.map((skill, index) => (
                <motion.span
                  ...
                  animate={inView ? { opacity: 1, scale: 1 } : {}}
                  transition={{ duration: 0.4, delay: index * 0.1 }}
                  className="px-4 py-2 backdrop-blur-sm bg-cyber-darker/30 text-neon-pink border border-neon-pink hover:bg-neon-pink/10 transition-colors animate-glow-pink font-mono"
                >
                  {skill}
                </motion.span>
              ))}
